...
/// <summary>Same simplified Result-to-ProblemDetails mapping used by every other module's endpoints — see Subscriptions/SubscriptionEndpointResults for the rationale.</summary>
internal static class AdvertisingEndpointResults
{
