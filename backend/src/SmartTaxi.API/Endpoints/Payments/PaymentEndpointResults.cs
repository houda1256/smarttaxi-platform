...
/// <summary>Same simplified Result-to-ProblemDetails mapping used by the Ride module's endpoints — see RideEndpointResults for the rationale.</summary>
internal static class PaymentEndpointResults
{
